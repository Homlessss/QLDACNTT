...
//using UnityEngine.Purchasing.AppleTangle;
...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    public void InitializePurchasing()
    {
        ...
        /*var storeModule = module.AppleAppStore;

        // Kiểm tra và thiết lập public key cho IGooglePlayConfiguration
        if (storeModule != null && storeModule is IGooglePlayStoreConfiguration googlePlayStoreModule)
        {
            googlePlayStoreModule.SetPublicKey(AndroidKey);
        }*/

        // Kiểm tra và thiết lập public key cho IGooglePlayConfiguration
        if (module != null)
        {
            var googlePlayStoreModule = module as IGooglePlayConfiguration;
            if (googlePlayStoreModule != null)
            {
                //googlePlayStoreModule.SetPublicKey(AndroidKey);
            }
        }
